...
extension NSObject {
    ...
    func showSheet(title: String? = nil, textArr: [String], block:((Int)->Void)?) {
        ...
        if Thread.isMainThread {
            ...
            if !AlertTool.isShowAlearly {
                
                let tool = AlertTool(frame: UIScreen.main.bounds)
...
extension AlertTool: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var cell = tableView.dequeueReusableCell(withIdentifier: "AlertTool")
        if cell == nil {
            
            cell = UITableViewCell(style: .default, reuseIdentifier: "AlertTool")
